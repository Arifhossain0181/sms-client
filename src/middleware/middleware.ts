...
const dashboardRoutes: Record<Role, string[]> = {
  ...
  STUDENT: ["/dashboard", "/dashboard/student", "/dashboard/result", "/dashboard/fees", "/dashboard/notices", "/dashboard/timetable", "/dashboard/notification"],
  PARENT: ["/dashboard", "/dashboard/parent", "/dashboard/student", "/dashboard/result", "/dashboard/fees", "/dashboard/notices", "/dashboard/timetable", "/dashboard/notification"],
