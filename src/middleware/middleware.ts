...
const dashboardRoutes: Record<Role, string[]> = {
  ...
  SCHOOL_ADMIN: [
    ...
    "/dashboard/result",
    "/dashboard/fees",
    "/dashboard/accountant/fee-structure",
    "/dashboard/accountant/transactions",
    "/dashboard/accountant/overdue",
    "/dashboard/notices",
    "/dashboard/admission",
    "/dashboard/notification",
    "/dashboard/approvals",
    "/dashboard/hr",
    "/dashboard/school-admin/admissions",
    "/dashboard/school-admin/classes",
    "/dashboard/school-admin/subjects",
    "/dashboard/school-admin/teachers",
    "/dashboard/school-admin/staff-roles",
    "/dashboard/school-admin/escalations",
...
const roleRoutes: Record<Role, string[]> = {
  ...
  HR: ["/dashboard", "/teachers", "/attendance", "/notices", "/notifications", "/hr", "/recruitment", "/admission"],
};
