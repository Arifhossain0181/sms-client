        ...
        <div className="bg-white/80 dark:bg-slate-900/60 backdrop-blur-2xl rounded-3xl border border-white/30 dark:border-white/10 shadow-2xl shadow-slate-200/40 dark:shadow-none overflow-hidden">
          ...
          <div className="p-4 sm:p-6 border-b border-white/30 dark:border-white/5">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {[
                { label: "Total Schools", value: schools.length, icon: Building2, color: "from-sky-400 to-indigo-500" },
                { label: "Active Schools", value: activeSchools, icon: CheckCircle, color: "from-emerald-400 to-teal-500" },
                { label: "Total Students", value: totalStudents, icon: GraduationCap, color: "from-violet-400 to-purple-500" },
                { label: "Total Teachers", value: totalTeachers, icon: Users, color: "from-orange-400 to-amber-500" },
              ].map((stat, i) => (
                <motion.div
                  key={stat.label}
                  custom={i}
