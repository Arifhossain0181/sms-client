...
export default function ParentPaymentsPage() {
  ...
  const stats = [
    { label: "Total Paid", value: `৳${summary.totalPaid.toLocaleString()}`, icon: TrendingUp, color: "from-emerald-400 to-teal-500" },
    { label: "Pending", value: `৳${summary.totalPending.toLocaleString()}`, icon: Clock, color: "from-amber-400 to-orange-500" },
    { label: "Failed", value: `৳${summary.totalFailed.toLocaleString()}`, icon: AlertTriangle, color: "from-rose-400 to-pink-500" },
    { label: "Total Payments", value: String(summary.count), icon: Receipt, color: "from-indigo-400 to-violet-500" },
  ];
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 mt-0.5">
                    Track all payments made for your children.
                  </p>
                </div>
              </div>
                ...
                >
                  ...
                  <div className="rounded-2xl border border-white/30 dark:border-white/10 bg-white/60 dark:bg-white/5 backdrop-blur-sm overflow-hidden">
                    <div className="px-6 py-4 border-b border-white/30 dark:border-white/10 flex items-center gap-2">
                      ...
                      <h3 className="text-sm font-semibold text-slate-800 dark:text-slate-200">Payment Transactions</h3>
                    </div>
                    ...
                    {paymentsLoading ? (
                      ...
                      <div className="p-12 text-center">
                        ...
                        <p className="text-sm font-medium text-slate-700 dark:text-slate-200">No payment records found</p>
                        <p className="text-xs text-slate-400 dark:text-slate-500 mt-1">Payment history will appear here.</p>
                      </div>
                    ) : (
                            ...
                            >
                              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                                <div className="space-y-1">
                                  ...
                                  {payment.note && (
                                    <p className="text-xs text-slate-400 dark:text-slate-500 italic">{payment.note}</p>
                                  )}
                                </div>
                                ...
                                <div className="flex items-center gap-4 sm:gap-6">
                                  ...
                                  {payment.pdfReceiptUrl && (
                                    <motion.a
                                      ...
                                      className="inline-flex items-center gap-1.5 rounded-xl border border-white/30 dark:border-white/10 bg-white/60 dark:bg-white/5 px-4 py-2 text-xs font-medium text-slate-700 dark:text-slate-200 hover:bg-white/80 dark:hover:bg-white/10 transition-colors"
                                    >
