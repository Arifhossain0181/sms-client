  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-50/50 dark:bg-slate-950">
      ...
      <div className="relative space-y-6">
        ...
        >
          <div>
            <h1 className="text-2xl lg:text-3xl font-bold tracking-tight text-slate-800 dark:text-white">Promotions</h1>
          ...
          {[
            {
              ...
              bg: "bg-white/80 dark:bg-slate-900/60 backdrop-blur-2xl rounded-3xl border border-white/30 dark:border-white/10 shadow-2xl",
              icon: GraduationCap,
            },
            {
              label: "Selected",
            ...
            <div key={label} className={`${bg} ${label === "Total Students" ? "" : "rounded-2xl"} p-4`}>
        ...
        <div className="space-y-4">
          ...
          {selectedCount > 0 && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              className="bg-white/80 dark:bg-slate-900/60 backdrop-blur-2xl rounded-3xl border border-white/30 dark:border-white/10 shadow-2xl border-blue-200 dark:border-blue-800/40 p-4 flex flex-wrap items-center gap-3"
            >
          ...
          >
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-border/60 bg-gradient-to-r from-sky-50 via-indigo-50 to-violet-50 dark:from-sky-500/10 dark:via-indigo-500/10 dark:to-violet-500/10">
                      ...
                      >
                        ...
                        <td className="px-5 py-3.5">
                          <div className="flex items-center gap-3">
                            <div className="w-8 h-8 rounded-full bg-white dark:bg-slate-700 flex items-center justify-center text-xs font-bold text-primary shrink-0">
                              {student.name
                                .split(" ")
                                .map((w) => w[0])
                                .slice(0, 2)
            ...
            {!isLoading && (students as Student[]).length > 0 && (
              <div className="px-5 py-4 border-t border-white/20 dark:border-white/10 flex items-center justify-between text-sm">
