...
const schema = z
  .object({
    ...
    studentFormEmail: z.string().email("Student email ঠিক নয়").optional(),
    ...
    if (data.payNow) {
      if (!data.paymentMethod) {
        ctx.addIssue({
          ...
          path: ["paymentMethod"],
          message: "Payment method select করো",
        });
      }
      ...
      <div className="relative mx-auto max-w-4xl">
        ...
        >
          ...
          <p className="mt-2 text-sm text-slate-600 dark:text-slate-400 max-w-xl mx-auto">
            StudentForm + AdmissionForm একসাথে পূরণ করুন
          </p>
        </motion.div>
          ...
          <div className="p-6 sm:p-8 lg:p-10 space-y-10">
            ...
            <div>
              ...
              <div className="mt-5 grid gap-5 md:grid-cols-2">
                ...
                <Field delay={0.1}>
                  <label className={labelCls}>
                    <Mail className="h-3.5 w-3.5 text-indigo-500" /> Student Email (Login এর জন্য)
                  </label>
                ...
                <Field delay={0.45} span={2}>
                  ...
                  >
                    <ImageIcon className="h-3.5 w-3.5 text-emerald-500" /> Student Photo <span className="text-slate-400 font-normal">(optional)</span>
                  </label>
